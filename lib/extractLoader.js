"use strict";var _interopRequireWildcard = require("@babel/runtime/helpers/interopRequireWildcard");var _interopRequireDefault = require("@babel/runtime/helpers/interopRequireDefault");Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _asyncToGenerator2 = _interopRequireDefault(require("@babel/runtime/helpers/asyncToGenerator"));var _vm = _interopRequireDefault(require("vm"));
...
function evalDependencyGraph({ loaderContext, src, filename, publicPath = "" }) {
  ...
  evalModule(_x2, _x3) {return _evalModule.apply(this, arguments);}function _evalModule() {_evalModule = (0, _asyncToGenerator2.default)(function* (src, filename) {
      ...
      const sandbox = Object.assign({}, global, {
        ...
        require: function (_require) {function require(_x4) {return _require.apply(this, arguments);}require.toString = function () {return _require.toString();};return require;}(givenRelativePath => {const _extractQueryFromPath =
          extractQueryFromPath(givenRelativePath),relativePathWithoutQuery = _extractQueryFromPath.relativePathWithoutQuery,query = _extractQueryFromPath.query;
...
module.exports = extractLoader;var _default =
extractLoader;exports.default = _default;